...
$result_1 = mysql_query("SELECT * FROM room_executive_suite");
...
if(isset($_POST['update']))
{
   ...
   mysql_select_db("hotel");
    ...
    mysql_query("UPDATE room_executive_suite SET id = '$id_no',check_in_date = '$check_in_date' , check_out_date='$check_out_date' , availibility = '$availibility' WHERE room_no = '$room' ");
